class DishesController < ApplicationController
  ...
  # GET /dishes.json
  def index
    @dishes = Dish.all.order("created_at DESC").paginate(page: params[:page], per_page: "4")
  end
  ...
  def create
    ...
    respond_to do |format|
      if @dish.save
        format.html { redirect_to @dish, notice: 'Dish added successfully!' }
  ...
  def destroy
    @dish.destroy
    respond_to do |format|
      format.html { redirect_to dishes_url, notice: 'Dish was successfully deleted.' }
